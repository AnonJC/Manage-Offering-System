     ...
     <section id="skeptable" class="container bg-primary" style="padding:20px;">
         <div class="login-box">
           ...
           <div class="login-box-body">
             <p class="login-box-msg">Choose from the following subject: </p>
             ...
             <form action="viewsubjects.php" method="post">
               <div class="form-group ">
                   ...
                   <select class="form-control select2 " style="width: 100%;" name="subject" required="">
                     ...
                     <?php
                      $querylist = "SELECT subjectid, subjectname FROM sis.subject";
               ...
               <br>
               <hr class="btn-danger">
               <button type="submit" class="btn btn-danger btn-block">View</button>
             </form>
           </div>
           <!-- /.login-box-body -->
         </div>
