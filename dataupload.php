              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-right">
                    <a href="dataupload.php" class="btn btn-default btn-flat">Sign ou1t</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <div style="margin-left:17%; margin-right: 10%;">
          <div style="width: 90%;" class=" box box-solid box-danger control-label box">
            <div class="box-header with-border ">
              <h2 class="box-title">Uploading Data</h2>
            </div>
              <form action="uploadingdata.php" method="POST" style="margin-top:20px">
                <div class="col-sm-6">
                ...
                <div class="form-group ">
                    <label>Subject Name</label>
                        <select class="form-control select2 " style="width: 100%;" name="subject" required="">
                          ...
                          <?php
                           $querylist = "SELECT subjectid, subjectname, descriptivetitle FROM sis.subject";
                           $listresult = pg_query($querylist);
                              while($row_list=pg_fetch_array($listresult))
                              {
                ...
                <div class="form-group">
                  <label>Section</label>
                  <input type="text" name="section" class="form-control" value="" required="" placeholder="Section">
                </div>
                <div class="form-group">
                  <label>Slots</label>
                  <input type="number" name="slots" class="form-control" value="" required="" placeholder="Slots">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Lecture Start</label>
                     <div class="input-group clockpicker">
                       <input type="text" class="form-control" value="" name="lecturestart" placeholder="Lecture Start" required="">
                ...
                <div class="form-group">
                  <label>Lecture End</label>
                     <div class="input-group clockpicker">
                       <input type="text" class="form-control" value="" name="lectureend" placeholder="Lecture End" required="">
                        <span class="input-group-addon">
                          <span class="glyphicon glyphicon-time"></span>
                        </span>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="lecturedays" class="form-control" value="" placeholder="Lecture Days"required="">
                </div>
                <div class="form-group">
                  <label>Lab Start</label>
                     <div class="input-group clockpicker">
                       <input type="text" class="form-control" value="" name="labstart" placeholder="Lab Start">
                        <span class="input-group-addon">
                          <span class="glyphicon glyphicon-time"></span>
                        </span>
                    </div>
                ...
                <div class="form-group">
                  <label>Lab End</label>
                     <div class="input-group clockpicker">
                       <input type="text" class="form-control" value="" name="labend" placeholder="Lab End" >
                        <span class="input-group-addon">
                          <span class="glyphicon glyphicon-time"></span>
                        </span>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="labdays" class="form-control" value="" placeholder="Lab Days">
                </div>
              </div>
              <br>
              <br>
              <button type="submit" class="btn btn-danger btn-flat">Upload Offering</button>
              <br>
              <br>
